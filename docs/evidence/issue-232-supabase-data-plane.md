...
Local disposable stack (the test creates its own isolated Supabase workdir and ephemeral bucket, and cleanup failures fail the suite instead of being swallowed):
