...
| ----------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Run pauses at an approval gate, receives `request-changes`, and resumes       | `apps/api/src/approvals.test.ts` — `'request-changes rewinds to the design step, writes a repair artifact, and re-halts'`                                                                                                                                  |
