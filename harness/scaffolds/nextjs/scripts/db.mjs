...
// Both commands that change what is in the database end by asking the stack
// where it is and proving the seed landed. They differ only in whether the
// credentials are new: `start` writes them — the keys are generated by the
...
// `includes`, not `args[0] ===`.
if (args[0] === 'start' || args.includes('reset')) {
