 ...
 * machine-readable discriminator — callers check `instanceof
 * BrowserInfrastructureError` (as `toExecutionResult` does for
 * `ProviderAuthenticationError`) instead of matching the message text, which
 * is free to reword.
 */
