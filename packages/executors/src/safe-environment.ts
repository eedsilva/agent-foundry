import entries from './safe-env-allowlist.json' with { type: 'json' };
...
// see docs/adr/0033-app-secret-capabilities.md. The list lives in JSON so
// scripts/doctor.mjs can probe under the exact env execution will use.
const SAFE_ENV_ALLOWLIST = new Set<string>(entries);
